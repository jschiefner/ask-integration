AskIntegration = require '../lib/ask-integration'
...
describe "AskIntegration", ->
  ...
  describe "when the ask-integration:speak event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      # has been created
      expect(workspaceElement.querySelector('.ask-integration')).not.toExist()
      ...
      runs ->
        expect(workspaceElement.querySelector('.ask-integration')).toExist()

        askIntegrationElement = workspaceElement.querySelector('.ask-integration')
        expect(askIntegrationElement).toExist()
